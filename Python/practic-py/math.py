import math
#El módulo math proporciona funciones matemáticas estándar que permiten realizar operaciones 

#1. Funciones de Potencias y Logaritmos
#Permiten trabajar con exponentes y logaritmos.
...
#math.log1p(x). Devuelve el logaritmo natural, útil para valores pequeños.
...
#3. Funciones de Redondeo y Enteros
...
# Funciones Combinatorias y MCD/ MCM
